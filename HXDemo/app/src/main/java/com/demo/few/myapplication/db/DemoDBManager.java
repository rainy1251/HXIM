package com.demo.few.myapplication.db;
...
import com.demo.few.myapplication.BaseAplication;
import com.demo.few.myapplication.InviteMessage;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(BaseAplication.getInstance());
    }
