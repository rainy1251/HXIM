...
import com.demo.few.myapplication.InviteMessage.InviteMessageStatus;
import com.demo.few.myapplication.activity.ChatActivity;
import com.demo.few.myapplication.activity.MainActivity;
import com.demo.few.myapplication.db.DemoDBManager;
import com.demo.few.myapplication.db.InviteMessgeDao;
import com.demo.few.myapplication.db.UserDao;
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if(user != null){
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format(appContext.getString(com.hyphenate.easeui.R.string.at_your_in_group), user.getNickname());
                    }
                    return user.getNickname() + ": " + ticker;
                }else{
                    if(EaseAtMessageHelper.get().isAtMeMsg(message)){
                        return String.format(appContext.getString(com.hyphenate.easeui.R.string.at_your_in_group), message.getFrom());
                    }
    	...
    	messageListener = new EMMessageListener() {
            ...
            public void onMessageRecalled(List<EMMessage> messages) {
                for (EMMessage msg : messages) {
                    ...
                    EMTextMessageBody txtBody = new EMTextMessageBody(String.format(appContext.getString(com.hyphenate.easeui.R.string.msg_recall_by_user), msg.getFrom()));
